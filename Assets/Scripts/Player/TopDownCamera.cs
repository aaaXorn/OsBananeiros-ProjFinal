...
public class TopDownCamera : MonoBehaviour
{
    ...
    void Update()
    {
		...
		transform.position = (new Vector3(CameraDummy.transform.position.x, 0, CameraDummy.transform.position.z) -
							  (CameraDummy.transform.forward * adjustX) + (Vector3.up * adjustDistance));
